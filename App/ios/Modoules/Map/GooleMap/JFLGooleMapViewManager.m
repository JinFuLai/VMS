...
@interface JFLGooleMapViewManager : RCTViewManager
...
@implementation JFLGooleMapViewManager

RCT_EXPORT_MODULE(JFLGooleMapView)
...
RCT_EXPORT_METHOD(changeTypes:(nonnull NSNumber *)reactTag array:(NSDictionary *)dic){
  [self.bridge.uiManager addUIBlock:^(RCTUIManager *uiManager, NSDictionary<NSNumber *,UIView *> *viewRegistry) {
    JFLGooleMapView *mapView = (JFLGooleMapView *) viewRegistry[reactTag];
...
- (UIView *)view{
  return [[JFLGooleMapView alloc]init];
}
@end
