...
@connect(({SIMCardTypeList }) => ({
  SIMCardTypeList,
}))
class SIMCardTypeList extends React.Component {
  _columns = () => [
    {
      title: '名称',
      dataIndex: '1',
...
export default SIMCardTypeList;
