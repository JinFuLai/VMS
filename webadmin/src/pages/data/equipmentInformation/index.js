...
@connect(({equipmentInformationList }) => ({
  equipmentInformationList,
}))
class EquipmentInformationList extends React.Component {
  _columns = () => [
    {
      title: '设备',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'equipmentInformationList/search',
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'equipmentInformationList/delete',
...
export default EquipmentInformationList;
