...
@connect(({equipmentMessageList }) => ({
  equipmentMessageList,
}))
class EquipmentMessageList extends React.Component {
  _columns = () => [
    {
      title: '设备编号',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'equipmentMessageList/search',
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'equipmentMessageList/delete',
...
export default EquipmentMessageList;
