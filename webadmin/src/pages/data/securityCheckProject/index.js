...
@connect(({securityCheckProjectList }) => ({
  securityCheckProjectList,
}))
class SecurityCheckProjectList extends React.Component {
  _columns = () => [
    {
      title: '项目名称',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'securityCheckProjectList/search',
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'securityCheckProjectList/delete',
...
export default SecurityCheckProjectList;
