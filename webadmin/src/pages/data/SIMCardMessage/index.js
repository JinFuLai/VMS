...
@connect(({SIMCardMessageList }) => ({
  SIMCardMessageList,
}))
class SIMCardMessageList extends React.Component {
  _columns = () => [
    {
      title: 'SIM卡号',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'SIMCardMessageList/search',
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'SIMCardMessageList/delete',
...
export default SIMCardMessageList;
