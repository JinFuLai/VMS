...
@connect(({securityCheckConditionList }) => ({
  securityCheckConditionList,
}))
class SecurityCheckConditionList extends React.Component {
  _columns = () => [
    {
      title: '车牌号码',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'securityCheckConditionList/search',
  ...
  render() {
    const {
      securityCheckConditionList: { data },
    } = this.props;
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'securityCheckConditionList/delete',
...
export default SecurityCheckConditionList;
