...
@connect(({ accidentRecordsList }) => ({
  accidentRecordsList,
}))
class AccidentRecordsList extends React.Component {
  _columns = () => [
    {
      title: '车牌号码',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'accidentRecordsList/search',
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'accidentRecordsList/delete',
...
export default AccidentRecordsList;
