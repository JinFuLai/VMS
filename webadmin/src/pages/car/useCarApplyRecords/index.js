...
@connect(({useCarApplyRecordsList }) => ({
  useCarApplyRecordsList,
}))
class UseCarApplyRecordsList extends React.Component {
  _columns = () => [
    {
      title: '申请单号',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'useCarApplyRecordsList/search',
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'useCarApplyRecordsList/delete',
...
export default UseCarApplyRecordsList;
