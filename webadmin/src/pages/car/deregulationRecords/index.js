...
@connect(({deregulationRecordsList }) => ({
  deregulationRecordsList,
}))
class DeregulationRecordsList extends React.Component {
  _columns = () => [
    {
      title: '车牌号码',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'deregulationRecordsList/search',
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'deregulationRecordsList/delete',
...
export default DeregulationRecordsList;
