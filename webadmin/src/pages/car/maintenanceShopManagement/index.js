...
@connect(({maintenanceShopManagementList }) => ({
  maintenanceShopManagementList,
}))
class MaintenanceShopManagementList extends React.Component {
  _columns = () => [
    {
      title: '公司',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'maintenanceShopManagementList/search',
  ...
  render() {
    const {
      maintenanceShopManagementList: { data },
    } = this.props;
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'maintenanceShopManagementList/delete',
...
export default MaintenanceShopManagementList;
