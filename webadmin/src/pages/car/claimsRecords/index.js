...
@connect(({claimsRecordsList }) => ({
  claimsRecordsList,
}))
class ClaimsRecordsList extends React.Component {
  _columns = () => [
    {
      title: '车牌号码',
      dataIndex: '1',
...
export default ClaimsRecordsList;
