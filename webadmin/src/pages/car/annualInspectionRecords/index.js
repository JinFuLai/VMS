...
@connect(({annualInspectionRecordsList }) => ({
  annualInspectionRecordsList,
}))
class AnnualInspectionRecordsList extends React.Component {
  _columns = () => [
    {
      title: '车牌号码',
      dataIndex: '1',
  ...
  search = keyword => {
    ...
    const _this = this;
    dispatch({
      type: 'annualInspectionRecordsList/search',
  ...
  render() {
    const {
      annualInspectionRecordsList: { data },
    } = this.props;
  ...
  _deleteUser = () => {
    ...
    const _this = this;
    dispatch({
      type: 'annualInspectionRecordsList/delete',
...
export default AnnualInspectionRecordsList;
