        ...
        <div>
            <Form {...layout} name="nest-messages" onFinish={onFinish} validateMessages={validateMessages}>
                <Row gutter={24}>
                    ...
                    <Col span={8} key={3}>
                        <Form.Item name="3" label="维修原因" rules={[{ required: true, }]}>
                            <Input />
                        </Form.Item>
                    </Col>
                    <Col span={8} key={4}>
                    ...
                    <Col span={8} key={5}>
                        <Form.Item name="5" label="维修费用" rules={[{ required: true, }]}>
                            <Input />
                        </Form.Item>
                    </Col>
                    <Col span={8} key={6}>
                        <Form.Item name="6" label="维修方式" rules={[{ required: true, }]}>
                            <Select>
                                <Select.Option value="b1">保险理赔</Select.Option>
                                <Select.Option value="z2">自主维修</Select.Option>
                            </Select>
                        </Form.Item>
                    </Col>
                    <Col span={8} key={7}>
                        <Form.Item name="7" label="维修日期" rules={[{ required: true, }]}>
                    ...
                    <Col span={8} key={9}>
                        <Form.Item name="9" label="维修状态" rules={[{ required: true, }]}>
                            <Select>
                                <Select.Option value="3">维修结束</Select.Option>
                                <Select.Option value="4">维修中</Select.Option>
                            </Select>
                        </Form.Item>
                    </Col>
                    <Col span={8} key={10}>
                        <Form.Item name="10" label="维修地点" rules={[{ required: true, }]}>
                            <Select>
                                <Select.Option value="w3">场外维修</Select.Option>
                                <Select.Option value="w4">厂内维修</Select.Option>
                            </Select>
                        </Form.Item>
                    </Col>
                    <Col span={8} key={11}>
                        <Form.Item name="11" label="修理用时" rules={[{ required: true, }]}>
                            <Input />
                        </Form.Item>
                    </Col>
            ...
            <Form  {...layout__} name="nest-messages__" onFinish={onFinish} validateMessages={validateMessages}>
                <Row gutter={24}>
                    <Col span={24} key={1}>
                        <Form.Item name="1" label="维修条目" rules={[{ required: true, }]}>
