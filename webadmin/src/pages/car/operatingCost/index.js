...
@connect(({operatingCostList }) => ({
  operatingCostList,
}))
class OperatingCostList extends React.Component {
  _columns = () => [
    {
      title: '车牌号码',
      dataIndex: '1',
